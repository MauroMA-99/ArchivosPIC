# 1 "../Frecuenciometro_digital.X/LCD_4bits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Frecuenciometro_digital.X/LCD_4bits.c" 2
...
# 4 "../Frecuenciometro_digital.X/LCD_4bits.h" 2
